...
npx glyphhanger --css --jsdom \
  --whitelist ' &,-.@CDEFILNOPRST_acdefghiklmnoprstuwy' \
  --subset fonts/BarlowCondensed-Thin.ttf

npx glyphhanger --css --jsdom \
  --whitelist '、。「」あいうえおかがきくけげこごさしじすずせぜそたちっつづてでとどなにのはひふべほまめもやょよらりるれろわをんァアィイウェエォオカガキギクグケコゴサザシジスズセソタダチッツテデトドナニネノハバパヒビピフブプベボポマミムメモャュユョラリルレロンヴ・ー一上与中久事京人今介付任企会伝体何作使価係修値健入全公処出分切刊初判利制刷創力動務化十印参取受同名向命和品員問善器回団国在域基報場壁士多大奴好始委字学実室家宿寮対専小屋属山岡工市布師年庁広弁式引弾当形役徒従必性情成所手打技択担拓採推描提支改攻政教整文新方日明時景最期未本材東析果査校株案械検業楽構機民気汎決法洋津活済渡港澤然版物独献率現理生産用田町画留発登的相省県短研示社福私科程究立第等築簿米系級素索紹組経結緒締繁織義習考者職自舎般色芽萌葉行術表装製要見親解言計設証評語読課談財責走踏車転込連週進遊選部配野開間関附限院隔隣離音順領題類養香験高（）' \
